...
date: 2025-05-25
description: Solve LQPs using the Riccati recursion
tags:
categories:
related_posts: false
---
...
The square-root Riccati recursion is proposed in {% cite frison2013efficient %}. The key idea is to carry out the recursion in terms of the Cholesky factor $\mathcal{L}_k$ rather than $P_k$. The algorithm is provided below, along with the flop counts.
...
Finally, refer to the [repository](https://github.com/Luyao787/Riccati-LQR) for implementation details.
